...
cir = zeros(8);
cir(1) = scatter(location(1,1), location(1,2), radius); hold on; 
cir(2) = scatter(location(2,1), location(2,2), radius); hold on; 
cir(3) = scatter(location(3,1), location(3,2), radius); hold on; 
cir(4) = scatter(location(4,1), location(4,2), radius); hold on; 
cir(5) = scatter(location(5,1), location(5,2), radius); hold on; 
cir(6) = scatter(location(6,1), location(6,2), radius); hold on; 
cir(7) = scatter(location(7,1), location(7,2), radius); hold on; 
cir(8) = scatter(location(8,1), location(8,2), radius); hold on;
