...
mkdir(confpath)
configuration(confpath, tracking, labjack, tick, pointervisible, distance, reaches, condinfo, breakreaches, breakwait, posturalhold, rest, posturestart, reachwait, prepwait, delaywait, holdwait, colorduration)
...
for rep = 1:2
    ...
    for block = 1:4
        ...
        pause
        uiopen([cd '\Unity Builds\AllConditions\AllConditions.exe'],1)
        close all;
